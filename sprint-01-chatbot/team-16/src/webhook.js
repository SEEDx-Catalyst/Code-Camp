...
app.post('/', (req, res) => {
  ...
  res.send({
    ...
    [{
      type: 'text',
      content: 'Your top 5 sale opportunities are:',
    }, 
    {
      "type": "list",
      "content": {
        "elements": [{
            "title": "THP (90%)",
            "subtitle": "Weighted Amount: 270000.00$\nPotential  Amount: 300000.00$",
            "buttons": [{
              "title": "View Details",
              "type": "BUTTON_TYPE",
              "value": "View Details"
          ...
          {
            "title": "ABC (80%)",
            "subtitle": "Weighted Amount: 200000.00$\nPotential  Amount: 250000.00$",
            "buttons": [{
              "title": "View Details",
              "type": "BUTTON_TYPE",
              "value": "View Details"
          ...
          {
            "title": "XYZ (70%)",
            "subtitle": "Weighted Amount: 140000.00$\nPotential  Amount: 200000.00$",
            "buttons": [{
              "title": "View Details",
              "type": "BUTTON_TYPE",
              "value": "View Details"
          ...
          {
            "title": "MRC (60%)",
            "subtitle": "Weighted Amount: 90000.00$\nPotential  Amount: 150000.00$",
            "buttons": [{
              "title": "View Details",
              "type": "BUTTON_TYPE",
              "value": "View Details"
          ...
          {
            "title": "BELL (50%)",
            "subtitle": "Weighted Amount: 50000.00$\nPotential  Amount: 100000.00$",
            "buttons": [{
              "title": "View Details",
              "type": "BUTTON_TYPE",
              "value": "View Details"
